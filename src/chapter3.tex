...
\subsection{Vers l'économie de marché des capitaux} % (fold)
...
% subsection vers_l_economie_de_marche_des_capitaux (end)

\subsection{La globalisation financière et ses risques} % (fold)
...
% subsection la_globalisation_financiere_et_ses_risques (end)


% section le_passage_de_l_economie_d_endettement_a_celle_de_marche_financier (end)

\section{Le rôle de la monnaie} % (fold)
\label{sec:le_role_de_la_monnaie}

\subsection{Les fonctions de la monnaie} % (fold)
...
% subsection les_fonctions_de_la_monnaie (end)

\subsection{La demande d'encaisse monétaire ou demande de monnaie} % (fold)
...
% subsection la_demande_d_encaisse_monetaire_ou_demande_de_monnaie (end)



% section le_role_de_la_monnaie (end)

\section{Le rôle de la banque centrale} % (fold)
...
% section le_role_de_la_banque_centrale (end)
