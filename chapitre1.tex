...
\part{Introduction générale} % (fold)
\label{prt:introduction_generale}

\section{L'économie est-elle une science} % (fold)
...
% section l_economie_est_elle_une_science (end)

\section{Qu'est-ce que l'analyse économique} % (fold)
...
% section qu_est_ce_que_l_analyse_economique (end)

\section{Évolution dans la conception de l'analyse économique} % (fold)
...
% section evolution_dans_la_conception_de_l_analyse_economique (end)
